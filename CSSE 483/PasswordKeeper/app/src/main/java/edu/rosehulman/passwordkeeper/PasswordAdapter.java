...
public class PasswordAdapter extends RecyclerView.Adapter<PasswordAdapter.PasswordView> implements ChildEventListener {
        ...
        public PasswordView(View itemView) {
            ...
            mEditButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final View contentView = mInflator.inflate(R.layout.dialog_insert, null, false);
                    ...
                    final Dialog dialog = new AlertDialog.Builder(mInflator.getContext())
    ...
    public void onCancelled(FirebaseError firebaseError) {
        Log.d(Constants.TAG, "Cancelled, error: " + firebaseError.getMessage());
    }
}
